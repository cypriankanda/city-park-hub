...
//     try {
//       setIsLoading(true);
//       if (!formData.parkingSpaceId || !formData.startTime || !formData.endTime) {
//         toast.error('Please select parking spot and times');
//         return;
//       }

//       const bookingData = {
//         parking_space_id: Number(formData.parkingSpaceId),
...
//                             name="parkingSpot"
//                             value={spot.id}
//                             checked={formData.parkingSpaceId === spot.id}
//                             onChange={() => setFormData(prev => ({ ...prev, parkingSpaceId: spot.id }))}
